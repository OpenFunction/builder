...
// will be copied into the function image and the 'FUNCTION_PACKAGE' 
// strings will be replaced by the relevant package name.
// That edited file will then be compiled as with the user's function code
// to produce an executable app binary that launches the HTTP server.
package main
