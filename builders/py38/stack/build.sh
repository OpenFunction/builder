...
echo "> Building base py38common image"
docker build -t "py38common" - < "${DIR}/parent.Dockerfile"
echo "> Building openfunctiondev/buildpacks-py38-run:$TAG"
docker build --build-arg "from_image=py38common" -t "openfunctiondev/buildpacks-py38-run:$TAG" - < "${DIR}/run.Dockerfile"
echo "> Building openfunctiondev/buildpacks-py38-build:$TAG"
docker build --build-arg "from_image=py38common" -t "openfunctiondev/buildpacks-py38-build:$TAG" -f "${DIR}/build.Dockerfile" "${TEMP}"
