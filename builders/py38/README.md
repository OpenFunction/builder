## Build builder of python version 3.8
...
Definition of a ```Function``` for ```python 3.8``` is shown below:
...
spec:
  version: "v1.0.0"
  image: "<your registry name>/sample-python38-func:latest"
  # port: 8080 # default to 8080
  build:
    builder: "openfunctiondev/py38-builder:v1"
    params:
      FUNC_NAME: "hello"
      FUNC_TYPE: "http"
