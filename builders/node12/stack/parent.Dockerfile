...
RUN curl --fail --show-error --silent --location --retry 3 https://nodejs.org/dist/v12.22.1/node-v12.22.1-linux-x64.tar.gz | tar xz --directory /usr/local --strip-components=1
