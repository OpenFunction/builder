...
echo "> Building openfunctiondev/buildpacks/go116/run:$TAG"
docker build --build-arg "from_image=go116common" -t "openfunctiondev/buildpacks/go116/run:$TAG" - < "${DIR}/run.Dockerfile"
